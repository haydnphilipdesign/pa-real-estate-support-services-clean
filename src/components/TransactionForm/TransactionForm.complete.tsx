...
export function TransactionForm() {
  ...
  useEffect(() => {
    ...
    return () => {
      const existingStyle = document.getElementById(
        "transaction-form-global-styles"
      );
      if (existingStyle) {
    ...
    const applySelectStyles = () => {
      if (formContainerRef.current) {
        const selectElements =
          formContainerRef.current.querySelectorAll("select");
  ...
  const handleFixField = (field: string) => {
    ...
    if (!step) {
      ...
      const partialMatches = Object.keys(fieldToStepMapping).filter(
        (key) =>
      ...
      if (partialMatches.length > 0) {
        ...
        console.log(
          `Using partial match: ${partialMatches[0]} for field: ${field}`
        );
      }
    }
    ...
    if (step) {
      ...
      if (field.toLowerCase().includes("client")) fallbackStep = 3;
        ...
        field.toLowerCase().includes("warranty") ||
  ...
  // Fixed version with null check for targetElement
  useEffect(() => {
    // Scroll to form content whenever the step changes
    if (formContentRef.current && formContainerRef.current) {
      // Use the container's scrollTop to scroll within the container
      const container =
        formContainerRef.current.querySelector(".custom-scrollbar");
      if (container) {
  ...
  const handleCustomStepClick = (step: number) => {
    // Apply the step change directly without forced scrolling
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "verticalStepClick" as any,
      handleVerticalStepClick
    );
  ...
  return (
    <TooltipProvider>
      ...
      <div
        ...
        className="transaction-form-container w-full h-auto"
      >
        {/* Simplified form container */}
        <div ref={formContentRef} className="w-full p-4 md:p-6">
          {/* Form Content */}
          <div className="space-y-6 w-full">
            {currentStep === 1 && (
              <>
                <div
                  id="section-title"
                  className="pt-1 md:pt-2 mb-2 sm:mb-3 pb-1 sm:pb-2"
                >
                  ...
                  <div className="flex items-center mb-1">
                    <div className="flex items-center justify-center rounded-full w-8 h-8 bg-gradient-to-br from-white/30 to-white/10 shadow-md mr-2 border border-white/20">
                      ...
                      >
                        <path
                          d="M14.5 22V12C14.5 10.8954 13.6046 10 12.5 10H6.5C5.39543 10 4.5 10.8954 4.5 12V22"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M19.5 22V6C19.5 4.89543 18.6046 4 17.5 4H14.5C13.3954 4 12.5 4.89543 12.5 6V10"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <p className="text-white/80 text-xs sm:text-sm pl-2 border-l-4 border-white/30 ml-1">
                    This form will guide you through submitting a new real
                    estate transaction. Please select your role to get started.
                  </p>
                </div>
                <div className="flex-grow flex flex-col justify-center py-8">
                  <RoleSelection
                    ...
                    onRoleChange={(value) =>
                      setAgentData((prev) => ({ ...prev, role: value }))
                    }
                  ...
                  <div className="flex items-center mb-1">
                    <div className="flex items-center justify-center rounded-full w-8 h-8 bg-gradient-to-br from-blue-500 to-blue-600 shadow-md mr-2">
                      ...
                      >
                        ...
                        />
                        <path
                          d="M15 9.35C14.5 8.8 13.33 8 12 8C9.79 8 8 9.79 8 12C8 14.21 9.79 16 12 16C13.33 16 14.5 15.2 15 14.65"
                          stroke="currentColor"
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
            ...
            {currentStep === 8 && (
              <>
                ...
                >
                  ...
                  <div className="fancy-divider my-2"></div>
                  <p className="text-gray-600 text-xs sm:text-sm pl-2 border-l-4 border-blue-500/30 ml-1">
                    Please review your transaction details before proceeding to
                    sign and submit.
                  </p>
                </div>
                ...
                <div className="max-w-5xl mx-auto">
                  <div className="glass-effect bg-transparent rounded-xl p-4 border border-gray-200/30 shadow-lg relative overflow-hidden">
            ...
            {currentStep === 9 && (
              <>
                ...
                >
                  ...
                  <div className="fancy-divider my-2"></div>
                  <p className="text-gray-600 text-xs sm:text-sm pl-2 border-l-4 border-green-500/40 ml-1">
                    Please sign below to confirm all information is correct and
                ...
                <div className="w-full">
                  <div className="glass-effect rounded-xl p-4 border border-gray-200/30 shadow-lg relative overflow-hidden">
          ...
          {/* Simplified actions bar - only reset button */}
          <div className="form-actions-bar relative pt-3 border-t border-blue-700/20 bg-gradient-to-b from-blue-900/0 to-blue-900/50 backdrop-blur-sm z-10">
        ...
        <MobileNavBar
          ...
          onNext={currentStep === 9 ? handleSubmit : enhancedHandleNext}
          canGoNext={
            currentStep === 9
              ? Boolean(
                  signatureData.signature &&
                    signatureData.infoConfirmed &&
      ...
      <div className="text-left mt-1 mb-1 px-3 md:flex md:justify-between md:items-center text-gray-400/70">
        <p className="italic font-light text-xs">
          Every transaction is a work of art, carefully crafted with expertise
          and precision
        </p>
