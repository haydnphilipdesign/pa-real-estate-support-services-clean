...
// Import responsive styles now included in consolidated CSS
...
export function ResponsiveContainer({
  ...
  footerContent,
  noPadding = false,
  // disableResponsive param is reserved for future feature development
  ...
  const containerClasses = cn(
    ...
    !disableResponsive && isMobile && 'mobile-container',
    !disableResponsive && isTablet && 'tablet-container',
    !disableResponsive && isDesktop && 'desktop-container',
    disableResponsive && 'responsive-disabled',
    className
  );
  ...
  const contentClasses = cn(
    ...
    'form-content',
    noPadding && 'p-0',
    isMobile && 'safe-area-insets px-3 py-4',
    isTablet && 'px-4 py-5'
  );
