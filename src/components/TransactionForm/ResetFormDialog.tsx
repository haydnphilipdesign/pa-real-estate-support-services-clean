    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full relative overflow-hidden z-50 reset-form-dialog">
            <div className="mb-4">
            ...
            <div className="flex justify-end space-x-3 mt-6 dialog-actions">
              <Button
                variant="outline"
                onClick={handleClose}
                className="flex-1"
