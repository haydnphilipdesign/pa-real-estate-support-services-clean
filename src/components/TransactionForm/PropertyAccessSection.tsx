...
export const PropertyAccessSection: React.FC<PropertyAccessSectionProps> = ({
  ...
  return (
    <div className="space-y-4 property-information-section">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <Label htmlFor="propertyAccessType" className="text-white">Property Access Type*</Label>
          <Select
            value={data.propertyAccessType}
            onValueChange={(value) => onChange('propertyAccessType', value)}
          >
            <SelectTrigger id="propertyAccessType" className="border-white/20">
        ...
        {data.propertyAccessType !== 'APPOINTMENT ONLY' && (
          <div className="space-y-2">
            <Label htmlFor="lockboxAccessCode" className="text-white">Access Code*</Label>
            <Input
