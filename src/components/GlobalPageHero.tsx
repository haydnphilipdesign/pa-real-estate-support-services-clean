...
const GlobalPageHero: React.FC<GlobalPageHeroProps> = ({
  ...
  return (
    <motion.section
      ...
      exit="exit"
      style={{ 
        marginTop: '80px', // Account for the fixed header height
        minHeight: 'calc(100vh - 100px)', // Reduced height to match other components
        display: 'flex',
        flexDirection: 'column',
        justifyContent: 'flex-start', // Changed from center to reduce space
        alignItems: 'center',
        background: 'transparent',
        zIndex: 1,
        pointerEvents: 'auto',
        userSelect: 'auto',
        paddingTop: '30px' // Add padding to control positioning
      }}
    >
      ...
      {/* Content Container */}
      <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8 w-full max-w-full overflow-hidden" style={{ marginTop: '-40px' }}>
