...
// Section animation styles have been moved to individual components
  ...
  return (
    <div className="min-h-screen overflow-x-hidden max-w-full">
      ...
      >
        ...
        <div 
          className="absolute inset-0 bg-gradient-to-br from-brand-blue via-brand-blue/95 to-brand-blue"
          style={{ 
            backgroundImage: "linear-gradient(to bottom right, #1e40af, rgba(30, 64, 175, 0.95), #1e40af)",
            opacity: 1,
            visibility: "visible" 
          }}
        >
