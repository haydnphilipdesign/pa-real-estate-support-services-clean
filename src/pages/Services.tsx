...
// Note: Using ContentCard's built-in animations instead of custom animations
...
const Services: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <ContentCard
              ...
              hoverEffect="lift"
              iconContent={
                <div className="w-16 h-16 bg-gradient-to-br from-[#eac87d]/20 to-brand-blue/20 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <service.icon className="w-8 h-8 text-[#eac87d] group-hover:text-brand-blue transition-colors duration-300" />
                </div>
              }
              ...
              <ul className="space-y-2 mt-auto">
                {service.features.map((feature, i) => (
                  <li key={i} className="flex items-start text-gray-700">
                    <div className="h-2 w-2 min-w-[8px] bg-[#eac87d] rounded-full flex-shrink-0 mt-2 mr-2 ml-0" />
      ...
      {/* Process Section */}
      <ProcessSteps
        title={<span className="text-white opacity-80">How We Work Together</span>}
      ...
      >
        ...
        >
          <div className="w-full h-full bg-[#eac87d]/10 rounded-full blur-xl" />
        </motion.div>
      </ContentSection>
    </div>
  );
