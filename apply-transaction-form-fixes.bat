...
copy /Y src\components\ui\switch.tsx src\components\ui\switch.tsx.bak
echo Updated switch component styling

echo Updating Commission Section styling...
copy /Y src\components\TransactionForm\CommissionSectionImproved.tsx src\components\TransactionForm\CommissionSectionImproved.tsx.bak
echo Updated commission section styling

echo Updating Property Details Section styling...
copy /Y src\components\TransactionForm\PropertyDetailsSectionImproved.tsx src\components\TransactionForm\PropertyDetailsSectionImproved.tsx.bak
echo Updated property details section styling

echo Updating Transaction Form component...
copy /Y src\components\TransactionForm\TransactionForm.tsx src\components\TransactionForm\TransactionForm.tsx.bak
echo Updated transaction form component

echo Updating Role Selection component...
copy /Y src\components\TransactionForm\RoleSelection.tsx src\components\TransactionForm\RoleSelection.tsx.bak
echo Updated role selection component

echo Updating Transaction Form CSS...
copy /Y src\styles\pages\transaction-form.css src\styles\pages\transaction-form.css.bak
